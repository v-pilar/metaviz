...
Includes the wineq plots for the comparison of fixed-effect and random-effects models, 
specifically the wineq forest plot, wineq Gini plot and wineq Baujat plot,
as well as a forest plot variant for three-level meta-analysis.
